...
const pseudo = document.querySelector('#update_profile_form_pseudo');
const lastname = document.querySelector('#update_profile_form_lastname');
const firstname = document.querySelector('#update_profile_form_firstname');
const zipcode = document.querySelector('#update_profile_form_zipCode');
const city = document.querySelector('#update_profile_form_city');
