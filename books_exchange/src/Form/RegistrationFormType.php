    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('agreeTerms', CheckboxType::class, [
                ...
                'constraints' => [
                    new IsTrue([
                        'message' => 'La case doit être cochée pour s\'inscrire.',
                    ]),
                ],
                'label' => 'Vous acceptez les conditions générales d\'utilisation et la politique de confidentialité du site ÉchangeLivres.'
            ])
